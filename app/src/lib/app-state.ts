...
export interface IBranchesState {
   ...
   * Commitly and GitHub.com default to using 'main' as the default branch.
   *
   * Commitly users are able to configure the `init.defaultBranch` Git
...
export interface IChangesState {
  ...
  /**
   * The latest Commitly stash entry for the current branch, or `null`
