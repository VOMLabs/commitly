...
export class SubmoduleDiff extends React.Component<ISubmoduleDiffProps> {
  ...
  private renderOpenSubmoduleAction() {
    ...
    return (
      <span>
        <SuggestedAction
          title="Open this submodule on Commitly"
          description="You can open this submodule on Commitly as a normal repository to manage and commit any changes in it."
