...
> {
  ...
  public render() {
    return (
      <Dialog
        title="Move Commitly to the Applications folder?"
    ...
    return (
      <DialogFooter>
        <OkCancelButtonGroup
          ...
          okButtonTitle="This will move Commitly to the Applications folder in your machine and restart the app."
