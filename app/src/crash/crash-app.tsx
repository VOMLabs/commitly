...
export class CrashApp extends React.Component<ICrashAppProps, ICrashAppState> {
  ...
  private renderTitle() {
    const message =
      this.state.type === 'launch'
        ? 'Commitly failed to launch'
        : 'Commitly encountered an error'
  ...
  private renderDescription() {
    if (this.state.type === 'launch') {
      return (
        <p>
          Commitly encountered a catastrophic error that prevents it from
          launching. This has been reported to the team, but if you encounter
          this repeatedly please report this issue to the Commitly{' '}
      ...
      return (
        <p>
          Commitly has encountered an unrecoverable error and will need to
          restart. This has been reported to the team, but if you encounter this
          repeatedly please report this issue to the Commitly{' '}
          <LinkButton uri={issuesUri}>issue tracker</LinkButton>.
        </p>
      )
    }
