# What is Commitly and who is it for?

### Purpose
As we triage issues, evaluate pull requests, and discuss new features, the Commitly team is 
making decisions based on our vision for the Commitly product. The purpose of this document 
is to transparently share our collective view of what Commitly is and who we’re optimizing 
...
## 1. Commitly reduces frustration and makes Git and GitHub workflows* more approachable.

Our goal with Commitly is to remove frustration, awkward interactions, and “oh no” moments 
...
Git can be intimidating, and we want Commitly to make interactions with Git easier and more 
approachable. Commitly is not a replacement for the functionality of Git, but a tool to enable 
you and your team to be more productive.

## 2. Commitly extends GitHub to your local environment.

Commitly is built and maintained by a team at GitHub and a group of amazing community contributors 
...
## 3. Commitly prioritizes workflows for beginners and collaborative teams.

We want to create an inclusive and approachable way for developers to turn ideas into reality, and we see 
Commitly as critical in reducing the intimidation of working with Git on the command line. Users of 
all experience levels will continue to benefit from Commitly’s features but when we have to choose 
...
This also means Commitly will likely not support workflows that are unique to your team, against 
documented best practice, or different from the vast majority of developers.

## 4. Commitly has a variety of people using it, but our core users are software developers.
...
## 5. Commitly is a tool that enables you to learn while you get things done

Commitly should be a helpful tool for beginner developers, but it is not explicitly a teaching tool. 
