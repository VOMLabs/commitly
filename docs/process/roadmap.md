...
#### Creating a fork using Commitly (2.3)
...
#### New user tutorial to get started more easily doing a full workflow in Commitly (2.2)

- Tutorial entry point: [#8148](https://github.com/desktop/desktop/issues/8148)
- GitHub workflow tutorial using Commitly: [#8149](https://github.com/desktop/desktop/issues/8149)
